...
public interface ICacheProtocol {
     ...
     * @return
     */
    public <T> Set<T> zRangeByScore(String key, double min, double max, boolean rev)
            throws IOException;
     ...
     * @return
     */
    public <T> Set<T> zRangeByScore(String key, double min, double max, boolean rev, int offset,
     ...
     * @return
     */
    public Set<Tuple> zRangeByScoreWithScores(String key, double min, double max, boolean rev,
     ...
     * @throws IOException
     */
    List<Set<Tuple>> zRangeByScoreWithScores(String[] keys, double min, double max, boolean rev,
            int offset, int length) throws IOException;
     ...
     * @throws IOException
     */
    List<Tuple> zMergeRangeByScoreWithScores(String[] keys, double min, double max, boolean rev,
            int offset, int length) throws IOException;
    ...
    public long hSetCreateKeyIfNotExists(String key, String field, String value)
            throws IOException;
     ...
     * @throws IOException
     */
    long zAddWithMap(String key, Map<Object, Double> map, long len, boolean rev)
            throws IOException;
